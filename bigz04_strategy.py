...
class BigZ04(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(
            (
                self.entry_condition_12_enable.value &
                ...
                (dataframe['volume_mean_slow'] > dataframe['volume_mean_slow'].shift(48) * self.entry_volume_pump_1.value) &
                (dataframe['volume_mean_slow'] * self.entry_volume_pump_1.value < dataframe['volume_mean_slow'].shift(48)) &
                (dataframe['volume'] < (dataframe['volume'].shift() * self.entry_volume_drop_1.value)) &
        ...
        conditions.append(
            (
                self.entry_condition_11_enable.value &
        ...
        conditions.append(
            (
                self.entry_condition_0_enable.value &
        ...
        conditions.append(
            (
                ...
                (dataframe['close'] <  dataframe['bb_lowerband'] * self.entry_bb20_close_bblowerband_safe_1.value) &
                (dataframe['rsi_1h'] < 69) &
                (dataframe['open'] > dataframe['close']) &
        ...
        conditions.append(
            (
                ...
                (dataframe['close'] < dataframe['bb_lowerband'] *  self.entry_bb20_close_bblowerband_safe_2.value) &
        ...
        conditions.append(
            (
                ...
                (dataframe['rsi'] < self.entry_rsi_3.value) &

                (dataframe['volume_mean_slow'] > dataframe['volume_mean_slow'].shift(48) * self.entry_volume_pump_1.value) &
                (dataframe['volume_mean_slow'] * self.entry_volume_pump_1.value < dataframe['volume_mean_slow'].shift(48)) &
                (dataframe['volume'] < (dataframe['volume'].shift() * self.entry_volume_drop_3.value)) &
        ...
        conditions.append(
            (
                ...
                (dataframe['rsi_1h'] < self.entry_rsi_1h_1.value) &
        ...
        conditions.append(
            (
                ...
                ((dataframe['ema_26'] - dataframe['ema_12']) > (dataframe['open'] * self.entry_macd_1.value)) &
        ...
        conditions.append(
            (
                ...
                (dataframe['rsi_1h'] < self.entry_rsi_1h_5.value) &

                (dataframe['ema_26'] > dataframe['ema_12']) &
                ((dataframe['ema_26'] - dataframe['ema_12']) > (dataframe['open'] * self.entry_macd_2.value)) &
                ((dataframe['ema_26'].shift() - dataframe['ema_12'].shift()) > (dataframe['open']/100)) &
                (dataframe['close'] < (dataframe['bb_lowerband'])) &
        ...
        conditions.append(
            (
                ...
                (dataframe['rsi_1h'] < self.entry_rsi_1h_2.value) &
        ...
        conditions.append(
            (
                ...
                (dataframe['rsi_1h'] < self.entry_rsi_1h_3.value) &
        ...
        conditions.append(
            (
                ...
                (dataframe['rsi_1h'] < self.entry_rsi_1h_4.value) &
                (dataframe['rsi'] < self.entry_rsi_2.value) &
